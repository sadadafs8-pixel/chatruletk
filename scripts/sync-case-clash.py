...
for w,h in [(390,844),(393,852),(430,932)]:
 ...
 (root/name).write_text(f'<!doctype html><html><head><meta charset="utf-8"><title>CASE CLASH · {w} × {h} QA</title><style>body{{margin:0;background:#171923;color:#ccc;font:14px sans-serif;text-align:center}}iframe{{display:block;width:{w}px;height:{h}px;border:0;margin:16px auto;background:#05080e}}</style></head><body><p>CASE CLASH · viewport {w} × {h}</p><iframe title="iPhone viewport" src="https://htmlpreview.github.io/?https://github.com/sadadafs8-pixel/chatruletk/blob/case-clash-demo/case-clash/index.html"></iframe></body></html>')
